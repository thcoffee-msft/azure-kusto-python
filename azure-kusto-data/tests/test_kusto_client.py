        ...
        expected_dict = {
            ...
            "xdate": Series(
                [
                    ...
                    pandas.to_datetime("2014-01-01T01:01:01.0000000Z").tz_localize(UTC),
                    pandas.to_datetime("2015-01-01T01:01:01.0000001Z").tz_localize(UTC),
                    pandas.to_datetime("2016-01-01T01:01:01.0000002Z").tz_localize(UTC),
                    pandas.to_datetime("2017-01-01T01:01:01.0000003Z").tz_localize(UTC),
                    pandas.to_datetime("2018-01-01T01:01:01.0000004Z").tz_localize(UTC),
                    pandas.to_datetime("2019-01-01T01:01:01.0000005Z").tz_localize(UTC),
                    pandas.to_datetime("2020-01-01T01:01:01.0000006Z").tz_localize(UTC),
                    pandas.to_datetime("2021-01-01T01:01:01.0000007Z").tz_localize(UTC),
                    pandas.to_datetime("2022-01-01T01:01:01.0000008Z").tz_localize(UTC),
                    pandas.to_datetime("2023-01-01T01:01:01.0000009Z").tz_localize(UTC),
                ]
            ),
            "xsmalltext": Series(
